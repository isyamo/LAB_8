...
CREATE TABLE `inscription` (
  ...
  UNIQUE KEY `unique_etudiant_enseignement` (`etudiant_id`,`enseignement_id`),
...
INSERT INTO `inscription` VALUES (1,2,'2024-02-01'),(2,2,'2024-02-01'),(1,1,'2024-09-01'),(2,1,'2024-09-01');
